    ...
    if (bz._init_block()) {
      ...
      if (checkFileCrc) {
        ...
        if (targetStreamCRC !== bz.streamCRC) {
          _throw(
            Err.DATA_ERROR,
            'Bad stream CRC ' + '(got ' + bz.streamCRC.toString(16) + ' expected ' + targetStreamCRC.toString(16) + ')'
          );
        }
      }
